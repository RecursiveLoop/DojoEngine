...
var projects = new []
{
    sourceDir.Path + "DojoEngineAPI/DojoEngineAPI.csproj",
...
```bash
dotnet test DojoEngineAPI.Test
```
...
aws cloudformation describe-stacks \
    --stack-name dojoengineapi --query 'Stacks[].Outputs'
```
